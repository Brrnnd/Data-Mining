...
with torch.no_grad():  # Non-aktifkan gradien untuk pengujian
    for images, labels in test_loader:
        ...
        # Simpan hasil prediksi dan label sebenarnya untuk analisis
...
for i in range(5):  # Menampilkan 5 contoh
    print(f'Prediksi: {predictions[i]}, Label Sebenarnya: {actual_labels[i]}')
